    ...
    states = {
        ...
        ["coldstart-before-engine-start"] = {
            ...
            conditions = {
                ...
                { text = "Wait for CAUTION", cond = { "ind_neq", 3, "Caution", nil }, onlyOnce = true },
                { text = "ACK switch to reset CAUTION", cond = { "ind_eq", 3, "Caution", nil }, highlights = { "HLP_MFK_REC_ACK" } },
                ...
                { text = "Wait for BIT test to complete", cond = { "ind_eq", 1, "NGParamDisplay", "ERR", "ind_eq", 1, "LeftParamDisplay", "00" }, onlyOnce = true },
        ...
        ["coldstart-engine-start"] = {
            ...
            conditions = {
                ...
                { text = "At 10% Ng: Check battery voltage >= 14V", cond = { "param_gt", "ENGINE_NG_RPM", 0.1, "ind_gt", 1, "LeftParamDisplay", 13 }, onlyOnce = true },
                { text = "At 18% Ng: Check TGT rising", cond = { "param_gt", "ENGINE_NG_RPM", 0.18, "ind_gt", 2, "TGTDisplay", 500 }, onlyOnce = true },
                ...
                { text = "At 50% Ng: Check start voltage is 0", cond = { "param_gt", "ENGINE_NG_RPM", 0.50, "ind_eq", 1, "RightParamDisplay", "000" } },
        ...
        ["coldstart-run-up"] = {
            ...
            conditions = {
                ...
                { text = "Wait for TGT and RPM to stabilize", cond = { "ind_gt", 1, "LeftParamDisplay", 0.98 }, duration = 3 },
                { text = "Increase NP/NR to 100% using RPM trim", cond = { "ind_eq", 1, "LeftParamDisplay", "100" }, duration = 3, highlights = { "HLP_PILOT_ENG_RPM_TRIM" } },
            },
        ...
        ["coldstart-before-takeoff"] = {
            ...
            conditions = {
                ...
                { text = "Set MPD to VSD", cond = { "ind_neq", 3, "B1_TEXT", "VSD" }, highlights = { "HLP_RMFD_B1" } }
            },
